...
class Trainer:
    ...
    def train(self):
        ...
        self.best_model_path = 'best_model_ncf.pt'
        ...
        for epoch in range(self.num_epochs):
            ...
            with torch.no_grad():
                ...
                wandb.log({"predictions": wandb.Histogram(save_predictions), "ratings": wandb.Histogram(save_ratings)})
        ...
        artifact = wandb.Artifact(
            name=f"best_ncf_model_{wandb.run.id}",
            type="model",
            description=f"Best NCF model with val_rmse: {self.best_val_rmse:.4f}"
        )
